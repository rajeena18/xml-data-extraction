...
const XMLDataConverter = () => {
    ...
    const handleProcessFile = async () => {
        ...
        const resourceEndpoint = 'https://api.businesscentral.dynamics.com/v2.0/50b7a7db-965b-4a2e-8f58-39e635bf39b5/UAT/api/alletec/primavera/v2.0/companies(f08e82f1-72e8-ef11-9345-6045bd14c5d0)/p6resources';
        ...
        //         });
        //         if (!response.ok) throw new Error(`Resource error: ${await response.text()}`);
        //     }
        // } catch (err) {
        //     setStatus(`Error sending resource data: ${err.message}`);
        //     return;
        ...
        const projectEndpoint = 'https://api.businesscentral.dynamics.com/v2.0/50b7a7db-965b-4a2e-8f58-39e635bf39b5/UAT/api/alletec/primavera/v2.0/companies(f08e82f1-72e8-ef11-9345-6045bd14c5d0)/projects';
        ...
        const wbsEndpoints = 'https://api.businesscentral.dynamics.com/v2.0/50b7a7db-965b-4a2e-8f58-39e635bf39b5/UAT/api/alletec/primavera/v2.0/companies(f08e82f1-72e8-ef11-9345-6045bd14c5d0)/p6wbsstagingroots';
        ...
        //     for (const wb of wbs) {
        //         // console.log('Sending project to BC:', JSON.stringify(wb, null, 2));

        //         const response = await fetch(wbsEndpoints, {
        //             method: 'POST',
        //             headers: {
        //                 'Content-Type': 'application/json',
        //                 Authorization: `Bearer ${token}`,
        ...
        //         });
        //         if (!response.ok) throw new Error(`WBS error: ${await response.text()}`);
        //     }
        // } catch (err) {
        //     setStatus(`Error sending WBS data: ${err.message}`);
        //     return;
        ...
        const activityEndpoints = 'https://api.businesscentral.dynamics.com/v2.0/50b7a7db-965b-4a2e-8f58-39e635bf39b5/UAT/api/alletec/primavera/v2.0/companies(f08e82f1-72e8-ef11-9345-6045bd14c5d0)/p6activityroots';
        ...
        //         // console.log('Sending Activity to BC:', JSON.stringify(wb, null, 2));

        //         const response = await fetch(activityEndpoints, {
        //             method: 'POST',
        //             headers: {
        //                 'Content-Type': 'application/json',
        //                 Authorization: `Bearer ${token}`,
        ...
        //         });
        //         if (!response.ok) throw new Error(`Activity error: ${await response.text()}`);
        //     }
        // } catch (err) {
        //     setStatus(`Error sending Activity data: ${err.message}`);
        //     return;
        ...
        const resourceAssignmentEndpoints = 'https://api.businesscentral.dynamics.com/v2.0/50b7a7db-965b-4a2e-8f58-39e635bf39b5/UAT/api/alletec/primavera/v2.0/companies(f08e82f1-72e8-ef11-9345-6045bd14c5d0)/p6resourceassignmentroots';
        ...
        // const resourceAssignmentEndpoints = 'https://api.businesscentral.dynamics.com/v2.0/50b7a7db-965b-4a2e-8f58-39e635bf39b5/UAT/api/alletec/primavera/v2.0/companies(f08e82f1-72e8-ef11-9345-6045bd14c5d0)/resourceassignments';
        // try {
        //     for (let i = 0; i < resourceAssignmentItems.length; i++) {
        //         const resourceAssignment = resourceAssignmentItems[i];
        // 
        //         const response = await fetch(resourceAssignmentEndpoints, {
        //             method: 'POST',
        //             headers: {
        //                 'Content-Type': 'application/json',
        //                 Authorization: `Bearer ${token}`,
        //             },
        //             body: JSON.stringify(resourceAssignment),
        //         });
        // 
        //         if (!response.ok) {
        //             throw new Error(`ResourceAssignment error: ${await response.text()}`);
        //         }
        // 
        //         // Add 10-second delay after every 500 items
        //         if ((i + 1) % 300 === 0) {
        //             console.log(`Sent ${i + 1} records, pausing for 20 seconds...`);
